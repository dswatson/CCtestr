...
#' authors propose a new measure, the proportion of ambiguous clustering
#' (PAC), which represents the increase in the empirical CDF curve for each
#' potential cluster number \emph{k} over a user-defined sub-interval of the
#' consensus index generated by the consensus cluster algorithm. The default
#' settings of \code{window = c(0.1, 0.9)} are taken from the original PAC
